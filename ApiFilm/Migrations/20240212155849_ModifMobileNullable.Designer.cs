...
namespace ApiFilm.Migrations
{
    ...
    [Migration("20240212155849_ModifMobileNullable")]
    partial class ModifMobileNullable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApiFilm.Models.EntityFramework.Film", b =>
                {
            ...
            modelBuilder.Entity("ApiFilm.Models.EntityFramework.Notation", b =>
                {
            ...
            modelBuilder.Entity("ApiFilm.Models.EntityFramework.Utilisateur", b =>
                {
                    b.Property<int>("UtilisateurId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("ApiFilm.Models.EntityFramework.Notation", b =>
                {
                    b.HasOne("ApiFilm.Models.EntityFramework.Film", "FilmNote")
                        .WithMany("NotesFilm")
